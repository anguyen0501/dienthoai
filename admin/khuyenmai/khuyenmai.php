...
<table class="table table-hover m-auto text-center" >
	<thead class="badge-info" style="font-size: 14px;">
		<tr>
			<th>Mã KM</th><th>Tên khuyến mãi</th><th>Trị Giá</th><th>Mô Tả</th><th>Ngày bắt đầu</th><th>Ngày kết thúc </th><th class="badge-danger" colspan="3"></th>
		</tr>
	</thead>
 ...
 <?php $so=0;
	 while ($row=mysqli_fetch_array($rs)) { ?>
		<tr>
			<td><?php echo $row['MaKM']; ?></td><td><?php echo $row['TenKM']; ?></td><td><?php echo number_format($row['TriGia']).'đ'; ?></td>
			<td><?php echo $row['MoTa']; ?></td><td><?php echo $row['NgayBD']; ?></td><td><?php echo $row['NgayKT']; ?></td>
