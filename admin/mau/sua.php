<?php 
    $mamau=$_GET['mamau'];
    $sql_sua="SELECT * FROM `mau` WHERE TenMau='$mamau'";
  ...
  <form class="form-row " method="GET" action="mau/xuly.php" enctype="multipart/form-data">
	 <div class="form-group col-sm-4"></div><input hidden name="id" value="<?php echo $kq_sua['TenMau'];?>">
    <div class="form-group col-sm-3"><label class="m-auto" for="mamau">Tên Màu</label>
    	<input type="text" class="form-control" name="mamau" autofocus value="<?php echo $kq_sua['TenMau'];?>"></div>
