	...
	<div class="mar-l-r">
		<div class="card-footer thanhtoan">
			<form action="index.php?action=dathang" method="POST" accept-charset="utf-8">
				<div class="row">
					<div class="col-md-7" style="border-right: 1px solid #d8d8d8;">
						<center>
							<h6>Cập nhập địa chỉ giao hàng</h6>
							<hr>
							<div class="col-md-9">
							...
							<div class="col-md-9" style=" float: bottom">
					...
					<div class="col-md-5">
						<center>
							<h6>Phương thức thanh toán</h6>
							<hr>
						</center>
						<div>
							...
							<div class="custom-control custom-checkbox" style="margin-left: 15px;">
								...
								<label class="custom-control-label" for="customCheck1">
									<h5> Thanh toán khi nhận hàng</h5>
								</label>
							</div>
							<div class="custom-control custom-checkbox" style="margin-left: 15px;">
								<input type="radio" class="custom-control-input" id="customCheck2" disabled>
								<label class="custom-control-label" for="customCheck2">
									<h5> Thanh toán online <label style="font-size: 15px;">(coming soom)</label></h5>
								</label>
							</div>
						</div>
						<br>
						...
						<?php $tgt = 0;
						foreach ($_SESSION['gio_hang'] as $key) { ?>
							<div>
								...
								<label style="font-size: 12px;margin-top:3px;float: right;">
									<?php $tt = $key['SoLuong'] * $key['DonGia'];
									$km = $key['SoLuong'] * $key['KM'];
									echo number_format($tt) . 'đ' . ' (Giảm : ' . number_format($km) . ' đ)';
									$tgt = $tgt + ($tt - $km) ?></label>
							</div>
