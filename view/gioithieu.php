...
Tiến Đạt mobile cám ơn tất cả các khách hàng đã mua và ủng hộ chúng tôi trong suốt thời gian qua bằng lời cám ơn chân thành nhất .
    ...
    <img src="include/banner.png" width="1280" height="720">
	<p style="margin-bottom:10px; padding-left:436px;">Hình ảnh cửa hàng Điện Thoại An Trọng</p>
	<h4>Hồ Chí Minh</h4>
    <p >Địa chỉ : Tân Bình | Tel: 0328 006 072 </p>
</div>